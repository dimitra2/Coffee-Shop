    ...
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li  class="selected"><a href="deliv_login.php" id="dianomeas">Σύνδεση Διανομέα</a></li>
...
if(isset($_POST['submit']))
	{
		...
		$query =mysqli_query($db,"SELECT * FROM deliv WHERE username='$username' and password='$password'" );
		if($row = mysqli_fetch_array( $query))
		{
			...
			echo "<script>alert('Eπιτυχής σύνδεση διανομέα')</script>";
			
			echo "<script>window.location.href='deliv_menu.php'</script>";
		}
		else
			echo "<script>alert('Λάθος στοιχεία διανομέα')</script>";
	} 
?>
